...
Route::get('/archives/inbox', [ManageMailController::class, 'indexInbox'])->name('mails.inbox')->middleware('auth');
Route::get('/archives/sent', [ManageMailController::class, 'indexSent'])->name('mails.sent')->middleware('auth');
